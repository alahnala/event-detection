...
def main():
	...
	pickle_in = open("src/event_candidates/" + folder + "timesteps.pickle","rb")
	timesteps = pickle.load(pickle_in)
	pickle_in.close()
	pickle_in = open("src/event_candidates/" + folder + "timestep_to_datetime.pickle","rb")
	...
	pickle_in = open("src/event_candidates/" + folder + "final_events.pickle","wb")
	timesteps = pickle.dump(events, pickle_in)
	pickle_in.close()
	eliminated = set(all_phrase_clusters.keys()) - set(events.keys())
	# print("Eliminated", eliminated)
	pickle_in = open("src/event_candidates/" + folder + "eliminated.pickle","wb")
