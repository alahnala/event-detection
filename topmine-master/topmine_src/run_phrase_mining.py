...
stop_word_files = ["topmine-master/topmine_src/stopwords/allie.txt", "topmine-master/topmine_src/stopwords/tm_stopwords.txt", "topmine-master/topmine_src/stopwords/nltk_sw.txt"]
if len(arguments) > 6:
...
utils.store_partitioned_docs(partitioned_docs, path="topmine-master/{}/intermediate_output/{}.partitioneddocs.txt".format(folder, file_name.split('/')[-1]))
utils.store_vocab(index_vocab, path="topmine-master/{}/intermediate_output/{}.vocab.txt".format(folder, file_name.split('/')[-1]))
utils.store_frequent_phrases(frequent_phrases, path='topmine-master/{}/output/{}.frequent_phrases.txt'.format(folder, file_name.split('/')[-1]))
