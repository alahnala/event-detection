experimentOneParsable="/home/alcllahn/576replication/results/2019_experiment_allie/allie_parseable.txt";
timestamp() {
  date +"%X"
}
...
##preprocess
## echo "Running python3 data_prep/preprocess_tweets.py /local2/alcllahn/tweets/ /local2/alcllahn/data_sets/experimentOne/ experimentOne";
## python3 data_prep/preprocess_tweets.py /local2/alcllahn/tweets/ /local2/alcllahn/data_sets/experimentOne/ experimentOne;
scalingTmpDir=sample_dataset/;
## mkdir -p "${scalingTmpDir}";
totalTweets="$(python3 count_tweets.py ../sample_dataset/)"; # count total tweets

resultsFolder=results/demo_results/;
cd ..;
...
ToPMineMinSupport="10"; # paper = 40
ToPMinePhraseSize="10"; # paper = 5
